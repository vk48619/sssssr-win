...
namespace Shadowsocks.Controller
{
    ...
    {
        private const string GFWLIST_URL = "https://qianbai.ml/ssr-download/pac.txt";

        private const string GFWLIST_BACKUP_URL = "https://qianbai.ml/ssr-download/pac.txt";

        private const string GFWLIST_TEMPLATE_URL = "https://qianbai.ml/ssr-download/pac.pac";
